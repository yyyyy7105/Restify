...
const Notifications = () => {
  ...
  //     fetch(`${process.env.REACT_APP_API_URL}/notifications/${currentUserId}/list/?showNotReadOnly=${showNotReadOnly.toString()}&page=${page}`, requestOptions)
  ...
  useEffect(() => {
    ...
    fetch(
      `${process.env.REACT_APP_API_URL}/notifications/${currentUserId}/list/?showNotReadOnly=${showNotReadOnly.toString()}&page=${page}`,
      requestOptions
    )
      .then((response) => {
        if (response.ok) {
